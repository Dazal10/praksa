                      ...
                      <div>
                        ...
                        <form action="register.php" method="post">
                          ...
                          <?php } ?>
                              ...
                              <input type="text" name="uname" required placeholder="Uporabniško ime">
                              <input type="password" name="password" required placeholder="Geslo"><br><br>
                              <button type="sumbit">Registracija</button><br><br>
                              <button><a href="login.php">Prijavi se tukaj</a></button>
                        </form>
                      </div>
                    </div>
                  </div>
